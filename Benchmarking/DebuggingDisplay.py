...
def on_hover_intensity(event, pma_file_path, fig, ax, scatter_data, image_3d, tpf=1/100, R_0=56, Intense_axes_CH1=[0.48, 0.81, 0.5, 0.15], Intense_axes_CH2=[0.48, 0.56, 0.5, 0.15], FRET_axes=[0.48, 0.31, 0.5, 0.15], dist_axes=[0.48, 0.06, 0.5, 0.15], CH1_zoom_axes=[0.04, 0.06, 0.15, 0.15], CH2_zoom_axes=[0.22, 0.06, 0.15, 0.15]):
    ...
    for scatter, peaks, label in scatter_data:
        ...
        if cont:
            ...
            if event.name == "button_press_event":
                ...
                zoomed_image_CH1 = image_3d[y1_CH1:y2_CH1, x1_CH1:x2_CH1]
                ...
                ax_intensity_CH1.plot(time, tot_intensity_all_frames_CH1, color='b', label='CH2')
                ...
                ax_intensity_CH1.set_ylim(-255, max(tot_intensity_all_frames_CH1)+500)
                ...
                ax_intensity_CH2.set_ylim(-255, max(tot_intensity_all_frames_CH1)+500)
